    ...
    public partial class Test : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (selected_answ != "-1")
            {
                ...
                string good = Requests.POST("http://sprut-2.ddns.net:8080/", "send_answ", Requests.token+ "," + (actual_question+1).ToString() + "," + selected_answ); //отправка ответа на сервер
                if (good == "0")
                {
        ...
        {
            Requests.POST("http://sprut-2.ddns.net:8080/", "end_test", Requests.token);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            Requests.POST("http://sprut-2.ddns.net:8080/", "test_timer", Requests.token);
            var perfect_value = (double) Requests.test_timer / timer_full;
            time_progress_bar(perfect_value);
            label3.Text = "Осталось: " + Requests.test_timer.ToString() + " минут";
        }
